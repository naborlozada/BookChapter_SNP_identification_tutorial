...
do
        ...
        echo ">>>conmmand_line.trimmomatic: java -jar $trimmomatic PE -threads 30 -phred33 -trimlog $outfiles$trimclip_logfile $R1 $R2  $paired_dir_path$R1_paired  $unpaired_dir_path$R1_unpaired $paired_dir_path$R2_paired  $unpaired_dir_path$R2_unpaired  ILLUMINACLIP:/ngs-data/share_tools/tools/Trimmomatic-0.38/adapters/TruSeq3-PE.fa:2:30:10  LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36";
